...
if (WIN32)
	...
	if (${PROVIDER} STREQUAL "NVIDIA" AND DEFINED ENV{CUDA_PATH})
		...
		if (${PROVIDER} STREQUAL "Intel" AND DEFINED ENV{INTELOCLSDKROOT})
			...
			if (${PROVIDER} STREQUAL "AMD OCL-SDK" AND DEFINED ENV{OCL_ROOT})
			    message(STATUS "Found environment variables for ${PROVIDER}")
			    set(OPENCL_INCLUDE_SEARCH_PATHS "$ENV{OCL_ROOT}/include" PARENT_SCOPE)
			    set(OPENCL_LIBRARY_32_SEARCH_PATHS "$ENV{OCL_ROOT}/lib/x86" PARENT_SCOPE)
			    set(OPENCL_LIBRARY_64_SEARCH_PATHS "$ENV{OCL_ROOT}/lib/x86_64" PARENT_SCOPE)
			endif()
		    endif()
		endif()
	    endif()
	...
	set(CL_SDK_PROVIDER_LIST AMD Intel NVIDIA OCL-SDK) # NVIDIA only provdes headers for OpenCL up to 1.2
    endif()
